...
export default class DicomParsingMenu extends Component {
  ...
  toggleShowIgnoredFile = () => {
    this.setState((state) => {
      return { showIgnoredFiles: !state.showIgnoredFiles };
    });
  };
  ...
  toggleSanityCheckResultsPanel = () => {
    this.setState((state) => {
      return {
        showSanityCheckResultsPanel: !state.showSanityCheckResultsPanel,
      };
    });
  };
  ...
  toggleSettingsDialog = () => {
    this.setState((state) => {
      return { showSettingsDialog: !state.showSettingsDialog };
    });
  };
          ...
          left={
            <React.Fragment>
              ...
              <StyledButton
                ...
                disabled={true}
              >
                <Badge className="text-900" value={this.props.fileLoaded} />
              </StyledButton>
              <StyledButton
                type="button"
                label="Parsed:"
                ...
                disabled={true}
              >
                <Badge className="text-900" value={this.props.fileParsed} />
              </StyledButton>
              <StyledButton
                type="button"
                label="Ignored:"
                className={
                  this.props.ignoredFilesCount === 0 ? "p-button-outlined p-button-warning" : "p-button-warning"
                }
                style={{ width: "135px" }}
                onClick={this.toggleShowIgnoredFile}
              >
                <Badge severity="warning" value={this.props.ignoredFilesCount} />
              </StyledButton>
              <StyledButton
                type="button"
                label="Selected:"
              ...
              >
                <Badge className="text-900" value={this.props.selectedDicomFiles.length} />
              </StyledButton>
            </React.Fragment>
          }
          right={
            <React.Fragment>
              ...
              <StyledButton
                ...
                hidden={
                  this.props.sanityCheckResults.length === 0 && this.props.deIdentificationCheckResults.length === 0
                }
              />
              <StyledButton
                label="Upload"
                ...
                className="p-button-success"
                hidden={
                  this.props.uploadApiKey === null ||
                  this.props.sanityCheckResults.length > 0 ||
                  this.props.deIdentificationCheckResults.length > 0
                }
              />
            </React.Fragment>
          }
