...
function parseRpbFormattedDates(dateString) {
  ...
  const convertDate = (dateString) => dateString.replace(rpbFormattedDateRegex, "$<year>-$<month>-$<day>");
...
function parseDicomFormattedDates(dateString) {
  ...
  const convertDate = (dateString) => dateString.replace(dicomFormattedDateRegex, "$<year>-$<month>-$<day>");
