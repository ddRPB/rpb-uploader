      ...
      switch (element.tag) {
        ...
        case "x30060020":
          ...
          for (let structureSetROISequenceItem of element.items) {
            ...
            structureSetROIMap.set(
              "ROINumber",
              this._getString(structureSetROISequenceItem.dataSet.elements["x30060022"])
            );
            structureSetROIMap.set(
              "ReferencedFrameOfReferenceUID",
              this._getString(structureSetROISequenceItem.dataSet.elements["x30060024"])
            );
            structureSetROIMap.set(
              "ROIName",
              this._getString(structureSetROISequenceItem.dataSet.elements["x30060026"])
            );
            structureSetROIMap.set(
              "ROIGenerationAlgorithm",
              this._getString(structureSetROISequenceItem.dataSet.elements["x30060036"])
            );
          }
        ...
        case "x30060080":
          ...
          for (let rTROIObservationsItem of element.items) {
            ...
            rTROIObservationsMap.set(
              "ObservationNumber",
              this._getString(rTROIObservationsItem.dataSet.elements["x30060082"])
            );
            rTROIObservationsMap.set(
              "ReferencedROINumber",
              this._getString(rTROIObservationsItem.dataSet.elements["x30060084"])
            );
            rTROIObservationsMap.set(
              "ROIObservationLabel",
              this._getString(rTROIObservationsItem.dataSet.elements["x30060085"])
            );
            rTROIObservationsMap.set(
              "RTROIInterpretedType",
              this._getString(rTROIObservationsItem.dataSet.elements["x300600a4"])
            );
            rTROIObservationsMap.set(
              "ROI Interpreter",
              this._getString(rTROIObservationsItem.dataSet.elements["x300600a6"])
            );
          }
        ...
        case "x30060010":
          ...
          for (let frameOfReferenceItem of element.items) {
            ...
            if (frameOfReferenceItem.dataSet.elements["x00200052"]) {
              frameOfReferenceMap.set(
                "FrameOfReferenceUID",
                this._getString(frameOfReferenceItem.dataSet.elements["x00200052"])
              );
              ...
              if (frameOfReferenceItem.dataSet.elements["x30060012"]) {
                ...
                for (let rTReferencedStudyItem of frameOfReferenceItem.dataSet.elements["x30060012"].items) {
                  rTReferencedStudyMap.set(
                    "ReferencedSOPClassUID",
                    this._getString(rTReferencedStudyItem.dataSet.elements["x00081150"])
                  );
                  rTReferencedStudyMap.set(
                    "ReferencedSOPInstanceUID",
                    this._getString(rTReferencedStudyItem.dataSet.elements["x00081155"])
                  );
                  ...
                  if (rTReferencedStudyItem.dataSet.elements["x30060014"]) {
                    for (let referencedContourImagesItem of rTReferencedStudyItem.dataSet.elements["x30060014"].items) {
                      ...
                      referencedContourImagesMap.set(
                        "SeriesInstanceUID",
                        this._getString(referencedContourImagesItem.dataSet.elements["x0020000e"])
                      );
                      ...
                      if (referencedContourImagesItem.dataSet.elements["x30060016"]) {
                        for (let contourSequenceItem of referencedContourImagesItem.dataSet.elements["x30060016"]
                          .items) {
                          ...
                          contourMap.set(
                            "ReferencedSOPClassUID",
                            this._getString(contourSequenceItem.dataSet.elements["x00081150"])
                          );
                          contourMap.set(
                            "ReferencedSOPInstanceUID",
                            this._getString(contourSequenceItem.dataSet.elements["x00081155"])
                          );
                          this.referencedSopInstanceUids.add(
                            this._getString(contourSequenceItem.dataSet.elements["x00081155"])
                          );
                        }
                      }
      ...
      switch (element.tag) {
        ...
        case "x300c0060":
          ...
          for (let referencedStructureSetItem of element.items) {
            ...
            referencedStructureSetMap.set(
              "ReferencedSOPClassUID",
              this._getString(referencedStructureSetItem.dataSet.elements["x00081150"])
            );
            referencedStructureSetMap.set(
              "ReferencedSOPInstanceUID",
              this._getString(referencedStructureSetItem.dataSet.elements["x00081155"])
            );
            this.referencedSopInstanceUids.add(
              this._getString(referencedStructureSetItem.dataSet.elements["x00081155"])
            );
      ...
      switch (element.tag) {
        ...
        case "x300c0002":
          ...
          for (let referencedRTPlanItem of element.items) {
            ...
            referencedStructureSetMap.set(
              "ReferencedSOPClassUID",
              this._getString(referencedRTPlanItem.dataSet.elements["x00081150"])
            );
            referencedStructureSetMap.set(
              "ReferencedSOPInstanceUID",
              this._getString(referencedRTPlanItem.dataSet.elements["x00081155"])
            );
