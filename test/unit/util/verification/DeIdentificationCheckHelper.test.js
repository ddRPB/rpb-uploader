...
import DeIdentificationCheckMessages from "../../../../src/constants/deIdentificationConfigurationCheck/DeIdentificationCheckMessages";
import DeIdentificationCheckTypes from "../../../../src/constants/deIdentificationConfigurationCheck/DeIdentificationCheckTypes";
...
import DeIdentificationCheckHelper from "../../../../src/util/verification/DeIdentificationCheckHelper";
  ...
  describe("Burned In Annotation", () => {
    test("Burned In Annotation is not set", () => {
      const result = deIdentificationCheckHelper.evaluateSeries(
        { seriesInstanceUID: firstDicomSeries },
