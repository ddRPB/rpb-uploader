...
export default class TreeBuilder {
  ...
  buildVirtualNodesTree() {
    ...
    for (let rTStruct of rTStructsAfterFirstSplit) {
      const newNodes = rTStruct.splitBySOPInstanceUIDIfImageIsReferenced(
        this.rtViewVirtualSeriesNodes.referencedSOPInstanceUIDs
      );
    ...
    for (let rTPlan of rtPlansAfterFirstSplit) {
      const newNodes = rTPlan.splitBySOPInstanceUIDIfImageIsReferenced(
        this.rtViewVirtualSeriesNodes.referencedSOPInstanceUIDs
      );
        ...
        switch (modality) {
          ...
          case "RTPLAN":
            ...
            base.referencedSOPInstanceUIDs = new Set([
              ...
              ...seriesObject.getReferencedInstancesUIDs(),
            ]);
            break;
          case "RTDOSE":
