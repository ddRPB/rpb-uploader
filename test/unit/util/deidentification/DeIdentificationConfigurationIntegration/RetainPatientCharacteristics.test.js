...
describe("Retain Patient Characteristics Profile Integration Test", () => {
  ...
  test("Additional tags will indicate that the RETAIN_PATIENT_CHARACTERISTICS profile was applied on the data set", () => {
    ...
    expect(
      ...
      `00080100 - should be ${DeIdentificationProfileCodes.RETAIN_PATIENT_CHARACTERISTICS}`
    ...
    expect(
      ...
      `00080104 - should be ${DeIdentificationProfileCodesMeaning.RETAIN_PATIENT_CHARACTERISTICS}`
