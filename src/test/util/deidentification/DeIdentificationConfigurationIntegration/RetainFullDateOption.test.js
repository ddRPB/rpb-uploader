...
describe('Retain Patient Characteristics Profile Integration Test', () => {
    ...
    test("Additional tags will indicate that the RETAIN_LONG_FULL_DATES profile was applied on the data set", () => {
        ...
        expect(lastMethod['00080100'].Value, `00080100 - should be ${DeIdentificationProfileCodes.RETAIN_LONG_FULL_DATES}`)
        ...
        expect(lastMethod['00080104'].Value, `00080104 - should be ${DeIdentificationProfileCodes.RETAIN_LONG_FULL_DATES}`)
